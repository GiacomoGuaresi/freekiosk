...
<p>
  ...
  <a href="features-and-modes.md">🎛️ Features</a> •
...
|---|---|
| **🛡️ Reliability** | Enhanced kiosk stability and error recovery |
...
| 🎯 Focus Area | 📋 Planned Features |
|---|---|
| **☁️ Cloud Management** | MDM-style fleet management capabilities |
...
| **⌨️ ADB Provisioning** | ✅ Complete | Headless deployment |
| **👁️ Motion Detection** | ✅ Complete | Camera-based sensing |
...
| **☀️ Auto-brightness** | 📋 Planned | Sensor-based adjustment |
...
| 🎯 Feature | 📋 Status | 📝 Description |
|---|---|---|
| **☁️ Cloud Management** | 📋 Planned | Web-based fleet control |
